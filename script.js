(function () {
  ...
  var previewClassName = 'ytp-ad-preview-slot';
  ...
  function checkAndClickButtons() {
    ...
    existingButtons(classList).forEach(button => {
      ...
      console.log("is visible ----> ", isBtnVisible(document.getElementsByClassName(previewClassName)))
